...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_TOG, _______, _______,          _______,          KC_PGUP,
        _______,          _______, _______, KC_CALC, _______, _______, NK_TOGG, KC_MUTE, KC_VOLD, KC_VOLU, _______,          _______, RGB_VAI, KC_PGDN,
        GU_ON,   GU_OFF,  _______,                            KC_BATQ,                            _______, _______, _______, RGB_SAD, RGB_VAD, RGB_SAI
    )
};
